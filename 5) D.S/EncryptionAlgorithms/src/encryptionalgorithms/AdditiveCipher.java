 ...
 * @author Sharo
 */
public class AdditiveCipher extends javax.swing.JFrame {
    ...
    public AdditiveCipher(JFrame parent) {
        initComponents();
        this.parent = parent;
    ...
    private void buttonEncryptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonEncryptActionPerformed
        ...
        textCipher.setText(EncrytorDecrytor.AdditiveCipherEc(plaintext, key));
    ...
    private void buttonDecryptActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDecryptActionPerformed
        ...
        textPlaintext.setText(EncrytorDecrytor.AdditiveCipherDec(ciphertext, key));
